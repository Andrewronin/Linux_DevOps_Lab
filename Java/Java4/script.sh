...
#		  -Xmx512m \
#		  -verbose:gc \
#		  -Xloggc:\/vagrant\/logs\/gc.log \
#		  -XX:+HeapDumpOnOutOfMemoryError "
 
export JAVA_OPTS="-Xms256M -Xmx512M -XX:+PrintGC -Xloggc:/vagrant/gc.log -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/vagrant/dump.hprof" 
export CATALINA_OPTS="-Xms256M -Xmx512M -XX:+PrintGC -Xloggc:/vagrant/gc.log -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/vagrant/dump.hprof"
...
#sudo sed -i '/MemoryLeakServlet/a \ \ \ \ \ :<multipart-config \/>' /opt/tomcat/apache-tomcat-8.5.42/webapps/TestApp/WEB-INF/web.xml
sudo sed -i 's/<Context>/<Context allowCasualMultipartParsing="true">/' /opt/tomcat/apache-tomcat-8.5.42/conf/context.xml
